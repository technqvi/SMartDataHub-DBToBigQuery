...
def process_actual_acton_selecting(isFirstLoad, last_imported, content_id, add_tran, list_model_log, listForRemove, select_actual_action):
    ...
    return listModelLogObjectIDs,dfModelLog

listModelLogObjectIDs, dfModelLog = process_actual_acton_selecting(isFirstLoad, last_imported, content_id, add_tran, list_model_log, listForRemove, select_actual_action) 
...
def process_data_retrival_from_view(view_name, isFirstLoad, last_imported, view_name_id, add_tran, listModelLogObjectIDs, retrive_next_data_from_view, retrive_first_data_from_view, retrive_one_row_from_view_to_gen_df_schema_for_all_deleted_action):
...
df = process_data_retrival_from_view(view_name, isFirstLoad, last_imported, view_name_id, add_tran, listModelLogObjectIDs, retrive_next_data_from_view, retrive_first_data_from_view, retrive_one_row_from_view_to_gen_df_schema_for_all_deleted_action)
...
def transform_data(view_name_id, pk_fk_list, df):
...
df = transform_data(view_name_id, pk_fk_list, df)
...
def ingest_data_to_bigquery(view_name, dt_imported, data_name, sp_name, view_name_id, app_table_name, way, pk_fk_list, datetime_list, check_fileds_in_view_source_in_web_admin_existing_in_database, projectId, main_dataset_id, client, get_bq_table, insertDataFrameToBQ, df):
    if way=='merge':
...
ingest_data_to_bigquery(view_name, dt_imported, data_name, sp_name, view_name_id, app_table_name, way, pk_fk_list, datetime_list, check_fileds_in_view_source_in_web_admin_existing_in_database, projectId, main_dataset_id, client, get_bq_table, insertDataFrameToBQ, df)   
